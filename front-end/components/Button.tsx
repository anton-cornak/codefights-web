...
export const buttonVariants = cva(
	"active:scale-95 inline-flex items-center justify-center rounded-md text-sm font-medium transition-color focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 disabled:opacity-50 dark:focus:ring-slate-400 disabled:pointer-events-none dark:focus:ring-offset-slate-900",
	{
		variants: {
			variant: {
				default:
					"font-bruno bg-green text-white hover:bg-light-green dark:bg-color2 dark:text-900 dark:hover:bg-light-green",
				outline:
				...
				link: " font-bruno bg-transparent dark:bg-transparent underline-offset-4 hover:underline text-black dark:text-white hover:bg-transparent dark:hover:bg-transparent",
			},
			size: {
